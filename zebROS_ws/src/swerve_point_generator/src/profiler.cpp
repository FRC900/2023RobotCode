									   ...
									   const std::vector<double> &end_points, double t_shift, bool flip_dirc)
{
	...
	{
		ROS_INFO_STREAM("in back pass, orientation_velocities = " << holder_point.angular_velocity);
		i -= curr_v * dt_;
		if (i < 0)
		{
			continue;
