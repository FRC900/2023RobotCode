                                                        ...
                                                        ros::NodeHandle                 &controller_nh)
{
	...
	*/
    ...
    //service_command_ = controller_nh.advertiseService("intake_command", &ClimberController::cmdService, this);
...
/*
bool ClimberController::cmdService(climber_controller::ClimberSrv::Request &req, climber_controller::ClimberSrv::Response &response) {
    if(isRunning())
    {
