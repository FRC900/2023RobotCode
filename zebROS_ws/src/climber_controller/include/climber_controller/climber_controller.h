...
class ClimberController : public controller_interface::MultiInterfaceController<hardware_interface::TalonCommandInterface, hardware_interface::JointStateInterface, hardware_interface::PositionJointInterface>
{
        public:
            ClimberController()
            {
            ...
            /*virtual bool cmdService(climber_controller::ClimberSrv::Request &req,
					                climber_controller::ClimberSrv::Response &res);*/
