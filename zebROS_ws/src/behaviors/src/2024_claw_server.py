...
class Claw2024ActionServer(object):
    ...
    def execute_cb(self, goal: Claw2024Goal):
        ...
        if goal.mode == goal.INTAKE_CLAW:
            ...
            claw_pub.publish(pct_out)
            while switch == 0:
                rospy.Subscriber("/frcrobot_rio/joint_states", JointState, callback)
...
if __name__ == '__main__':
    ...
    #outtake_speed = 1
    #delay = 0.5
    claw_pub = rospy.Publisher("/frcrobot_jetson/claw_controller/command", Float64, queue_size=1)
