...
int main(int argc, char** argv)
{
	...
	AlignHatchPanelAction align_hatch_action("align_hatch_server",
			...
			"/align_server/align_server_params/align_timeout",
			"/align_server/align_server_params/orient_timeout",
			"/align_server/align_server_params/x_timeout",
			"/align_server/align_server_params/y_timeout",

			"/align_server/align_server_params/orient_error_threshold",
			"/align_server/align_server_params/x_error_threshold",
			"/align_server/align_server_params/y_error_threshold");
