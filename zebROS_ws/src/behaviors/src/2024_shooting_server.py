...
class ShootingServer(object):
    ...
    def __init__(self, name):
        ...
        ddynrec.add_variable("subwoofer_pivot_position", "float/double variable", rospy.get_param("subwoofer_pivot_position"), 0.45, 1.5)
        ...
        ddynrec.add_variable("amp_pivot_position", "float/double variable", rospy.get_param("amp_pivot_position"), 0.45, 1.5)
        ...
        ddynrec.add_variable("trap_pivot_position", "float/double variable", rospy.get_param("trap_pivot_position"), 0.45, 1.5)
        ...
        ddynrec.add_variable("lob_pivot_position", "float/double variable", rospy.get_param("lob_pivot_position"), 0.45, 1.5)
