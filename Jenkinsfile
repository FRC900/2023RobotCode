node {
   ...
   try {
       ...
       docker.image('frc900/zebros-2020-wpilib-beta-dev:latest').inside('--user root:root -v ' + env.WORKSPACE + ':/home/ubuntu/2019Offseason -l /bin/bash') { c ->
